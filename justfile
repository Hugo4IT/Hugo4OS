...
@build-kernel +ARGS:
	...
	RUSTFLAGS='-C strip=debuginfo' cargo build {{ARGS}} {{cargo-args}} --release --quiet --package hugo4os_x86_64_bios
	echo 'Ok!'

@create-image-bios +ARGS: check-dependencies (build-kernel ARGS) build-bios
